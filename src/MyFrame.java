    ...
    {   
      StringBuilder inArea = new StringBuilder();
        ...
        button_translate.addActionListener(e -> {
          ...
          try {
            textArea.setText(JsonParser.parseTranslateResult(api.getTransResult(textArea.getText(), "auto", "en")));
        ...
        {  
            ...
            inArea.delete(0, inArea.length());
            inArea.append(textArea.getText());
            if (!mIat.isListening()) mIat.startListening(new RecognizerListener()  
            {  
              ...
              {  
                  if (null != error)  
                  {  
                      JOptionPane.showMessageDialog(null, error.getErrorDescription(true), "ERROR:"+error.getErrorCode(), JOptionPane.ERROR_MESSAGE);
